...
public class QuestionController {
     ...
     * 获取AI对代码的分析建议
     *
     * @param request 包含代码和题目ID的请求
     * @return AI的分析建议
     */
    @PostMapping("/ai/code-analysis")
    public BaseResponse<String> getAICodeAnalysis(@RequestBody AIAnalysisRequest request, HttpServletRequest httpServletRequest) {
        if (request == null) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
        ...
        try {
            ...
            if (questionId != null && questionId > 0) {
                ...
                questionInfo = question.getTitle() + "\n" + question.getContent();
            }
            
            String suggestion = aiService.getCodeSuggestion(code, questionInfo);
