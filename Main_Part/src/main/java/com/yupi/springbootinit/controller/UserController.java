...
public class UserController {
    ...
    public BaseResponse<Boolean> updateMyUser(@RequestBody UserUpdateMyRequest userUpdateMyRequest,
        ...
        // 如果用户要修改密码
        if (StringUtils.isNotBlank(userUpdateMyRequest.getNewPassword())) {
            // 校验当前密码是否正确
        ...
        loginUser.setUserProfile(userUpdateMyRequest.getUserProfile());
    ...
    public BaseResponse<List<QuestionSubmitVO>> getUserQuestionHistory(HttpServletRequest request) {
        User loginUser = userService.getLoginUser(request);
        List<QuestionSubmitVO> questionSubmitVOList = questionSubmitService.getUserQuestionSubmitHistory(loginUser.getId());
